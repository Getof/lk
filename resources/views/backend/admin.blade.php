...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('back/css/admin.css') }}">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" integrity="sha256-eZrrJcwDc/3uDhsdt61sL2oOBY362qM3lon1gyExkL0=" crossorigin="anonymous" /></head>
<body>
...
<header class="page-header">
    <nav>
        <a href="#">
            <img class="logo" src="{{ asset('front/img/logo.svg') }}" alt="forecastr logo">
        </a>
...
<script type="text/javascript" src="{{ asset('back/js/admin.js') }}"></script>
</body>
</html>
