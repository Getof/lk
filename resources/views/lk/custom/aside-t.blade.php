<aside id="aside" class="aside">
    <div class="aside-container">
        ...
        <ul class="aside-links">
            <a href="{{ route('teacher.index') }}" class="aside-links__element router-link-exact-active aside-links-active">
            ...
            <a href="{{ route('teacher.material') }}" class="aside-links__element">
